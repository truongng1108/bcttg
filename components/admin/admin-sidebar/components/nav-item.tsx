    ...
    return (
      <li>
        <div className={groupClassName}>
          <Link href={item.href} className="flex flex-1 items-center gap-3" title={collapsed ? item.label : undefined}>
            <Icon className={cn("h-4 w-4 shrink-0", isActive || isChildActive ? "text-sidebar-primary" : "")} />
